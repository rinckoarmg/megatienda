    ...
    var users = $.ajax({
        ...
        success: function(data){
            $.each(data, function(i, item){
                ...
                columna6.innerHTML = "<a href = 'usuarios/eliminar/?cedula="+item.cedula_usuario+"'>Eliminar</a>";
                var columna7 = document.createElement("td");
                columna7.innerHTML = "<a href = 'usuarios/modificar/?cedula="+item.cedula_usuario+"'>Editar</a>";
